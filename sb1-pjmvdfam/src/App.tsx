...
import { Search, Loader2, AlertTriangle, Info, Mic, Settings, Database } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-indigo-900 text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-blue-500 flex items-center justify-center font-['Poppins',sans-serif]">
            <span>Pr</span>
            <img 
              src="https://stackblitz.com/storage/blobs/redirect/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBBd0xZYkE9PSIsImV4cCI6bnVsbCwicHVyIjoiYmxvYl9pZCJ9fQ==--bc18befae72e3e2aa8cb4c7c6ac001408f6b6bc2/logo.png" 
              alt="o" 
              className="w-12 h-12 md:w-16 md:h-16 inline-block mx-[-2px] transform translate-y-[2px]" 
            />
            <span>blepo</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto font-['Poppins',sans-serif]">
            ...
            >
              <div className="mb-6">
                <button
                  ...
                  className="px-4 py-2 bg-indigo-700 hover:bg-indigo-600 rounded-lg flex items-center text-white transition-colors"
                >
                  ← Back to Prediction
                </button>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                  ...
                  <div className="relative flex items-center mb-6">
                    ...
                    <div className="absolute right-2 flex items-center space-x-2">
                      ...
                      <motion.button
                        ...
                        className="rounded-full p-2 bg-indigo-700 text-white font-medium hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300"
                        aria-label="Toggle prediction details form"
                      >
                ...
                <div className="flex flex-col items-center">
                  ...
                  {!loading && !results && (
                    ...
                    >
                      <h2 className="text-2xl font-semibold mb-4 font-['Poppins',sans-serif]">Welcome to Problepo</h2>
