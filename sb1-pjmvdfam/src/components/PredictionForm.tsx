...
const PredictionForm: React.FC<PredictionFormProps> = ({ predictionRequest, handleInputChange }) => {
  return (
    ...
    >
      <h3 className="text-lg font-medium mb-4 font-montserrat">Prediction Details</h3>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          <label htmlFor="category" className="block text-sm font-medium text-gray-300 mb-1 font-montserrat">
            Category
          </label>
          <select
            id="category"
        ...
        <div>
          <label htmlFor="timeframe" className="block text-sm font-medium text-gray-300 mb-1 font-montserrat">
            Timeframe
          </label>
          <select
            id="timeframe"
      ...
      <div>
        <label htmlFor="context" className="block text-sm font-medium text-gray-300 mb-1 font-montserrat">
